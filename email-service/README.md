...
├── README.md              # This file
├── message_requests/      # CSV files with student data
│   ├── message_requests_Project 1.csv
│   └── message_requests_Project 2.csv
└── config/
...
- Missing email addresses → Skips student and logs warning
